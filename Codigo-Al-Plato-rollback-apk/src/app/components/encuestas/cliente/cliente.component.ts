    ...
    if (this.ValidarCampos()) {
      this.db
        ...
        .then((e) => {
          Swal.fire({
            heightAuto: false,
            title: this.diccionario[this.idioma()]['Encuestaregistrada'],
  ...
  ValidarCampos() {
    ...
    if (controlAt.errors !== null) {
      ...
      if (controlAt.errors!['required']) {
        this.mensajeAtencion = this.diccionario[this.idioma()]['DebeCompletarCampo'];
      }
    }
    if (controlSab.errors !== null) {
      ...
      if (controlSab.errors!['required']) {
        this.mensajeSabor = this.diccionario[this.idioma()]['DebeCompletarCampo'];
      }
    }
    if (controlCal.errors !== null) {
      ...
      if (controlCal.errors!['required']) {
        this.mensajeCaliente = this.diccionario[this.idioma()]['DebeCompletarCampo'];
      }
    }
    if (controlPor.errors !== null) {
      ...
      if (controlPor.errors!['required']) {
        this.mensajePorciones = this.diccionario[this.idioma()]['DebeCompletarCampo'];
      }
    }
    ...
    if (controlMenu.errors !== null) {
      ...
      if (controlMenu.errors!['required']) {
        this.mensajeMenu = this.diccionario[this.idioma()]['DebeCompletarCampo'];
      }
    }
    ...
    if (controlPres.errors !== null) {
      ...
      if (controlPres.errors!['required']) {
        this.mensajePresentacion = this.diccionario[this.idioma()]['DebeCompletarCampo'];
      }
    }
    if (controlTiem.errors !== null) {
      ...
      if (controlTiem.errors!['required']) {
        this.mensajeTiempo = this.diccionario[this.idioma()]['DebeCompletarCampo'];
      }
    }
