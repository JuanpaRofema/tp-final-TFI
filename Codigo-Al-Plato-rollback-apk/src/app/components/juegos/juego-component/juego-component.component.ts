  ...
  perdido() {
    ...
    if (this.auth.usuarioIngresado.descuento != 0) {
       if (this.puntosGuardados > 3 && this.perdioNum === 1) {
           this.showAlert(this.diccionario[this.idioma()]['Felicidades'], this.diccionario[this.idioma()]['AguantasteMasDe3'], true);
       } else {
           this.showAlert(this.diccionario[this.idioma()]['Muybien'], `${this.diccionario[this.idioma()]['Aguantaste']} ${this.puntos} ${this.diccionario[this.idioma()]['Segundos']}`, false);
       }
    } else {
       this.showAlert(this.diccionario[this.idioma()]['Muybien'], `${this.diccionario[this.idioma()]['Aguantaste']} ${this.puntos} ${this.diccionario[this.idioma()]['Segundos']}`, false);
    }
